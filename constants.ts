...
export const AR_TEXTS: LocalizedTexts = {
  ...
  CATEGORY_DETAIL_TITLE_SUFFIX:
    "جمعتهالك عالبارد 🔥 — اضغط على كل أداة لتخصيصها وتشغيلها ومراقبتها في الوقت الفعلي.",
  LIVE_OPERATIONS_TITLE: "عمليات KNOX الجارية - تقرير فوري، تفاعل مطلق 📡",
  LIVE_OPERATIONS_SUBTITLE:
    "شاشة التحكم المطلقة. شاهد جميع مهامك قيد التشغيل ونتائجها المباشرة. تتبع التقدم، قم بالإجراءات الفورية، وتحكم بالكامل في عملياتك من مكان واحد.",
  ...
  KNOX_DEEP_SCAN_LONG_DESC:
    "يستخدم KNOX Deep Scan خوارزميات متقدمة وقاعدة بيانات شاملة للتهديدات لفحص نظامك بدقة بحثًا عن البرامج الضارة والأنشطة المشبوهة ونقاط الضعف المحتملة. يحاكي فحصًا عميقًا لمناطق النظام الحيوية والعمليات قيد التشغيل وعناصر بدء التشغيل وسلامة الملفات. يمكن تحليل النتائج بواسطة Gemini AI للحصول على رؤى م��ززة.",
  ...
  EMAIL_BREACH_LOOKUP_LONG_DESC:
    "أدخل عنوان بريد إلكتروني للتحقق منه مقابل قاعدة بيانات لتسريبات البيانات المعروفة (محاكاة). تساعد هذه الأداة في تحديد التعرض المحتمل لبيانات الاعتماد أو المعلومات الشخصية. لإجراء عمليات تحقق حقيقية، استخدم خدمات موثوقة مثل Have I Been Pwned.",
  ...
  PRIVACY_TRACE_WIPER_DESC:
    "يحاكي تنظيف سجل المتصفح، ملفات تعريف الارتب��ط، والملفات المؤقتة.",
  PRIVACY_TRACE_WIPER_LONG_DESC:
    "تحاكي هذه الأداة عملية مسح البصمات الرقمية مثل ذاكرة التخزين المؤقت للمتصفح، ملفات تعريف الارتباط، السجل، ملفات النظام المؤقتة، وسجلات التطبيقات لتعزيز خصوصيتك. الحذف الفعلي محاكى للسلامة في بيئة الويب هذه.",
  ...
  MALWARE_PROCESS_KILLER_LONG_DESC:
    "تحاكي هذه الأداة فحص وإنهاء العمليات التي تطابق التوقيعات في قاعدة بيانات تهديدات KNOX أو تظهر سلوكًا مشبوهًا. في بيئة حقيقية، يتطلب هذا صلاحيات إدارية. هنا، يتم محاكاة الإجراءات.",
